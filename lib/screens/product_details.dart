...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  List<CartProduct> cartProducts = await CartDatabaseHelper().getCartProducts();
  ...
  if (existingProduct.productId == -1) {
    ...
    if (result != 0) {
      ...
      setState(() {
        totalPrice += (widget.product!.price * itemCount); // Update total price based on itemCount
    ...
    int newQuantity = existingProduct.quantity + itemCount; // Update quantity based on itemCount
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          color: Color.fromARGB(255, 239, 140, 48),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  InfoBox(title: 'Calories', content: widget.product?.calories?.toString() ?? 'N/A'),
                  InfoBox(title: 'Vitamins', content: widget.product?.vitamins?.toString() ?? 'N/A'),
                  InfoBox(title: 'Additives', content: widget.product?.additives?.toString() ?? 'N/A'),
                ],
              ),
              SizedBox(height: 16.0),
              Container(
